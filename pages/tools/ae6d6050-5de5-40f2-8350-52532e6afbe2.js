    ...
    return (
        <Layout_sticky_navbar
            MenuItems=
                {(
                    <div className="left_content sm:static">
                        ...
                        <div className="bg-base-100 rounded-lg mt-4 p-4">
            ...
            page=
                {(
                    <div>
                    <div className=" grid grid-cols-1 mx-4 md:mx-0 md:grid-cols-3 auto-rows-max gap-4">
                        <div className="h-96 md:col-span-2 bg-base-100 rounded-lg">
                        </div>
                        <div className="h-96 bg-base-100 rounded-lg">
                        </div>
                        <div className="h-96 bg-base-100 rounded-lg">
                        </div>
                        <div className="h-96  md:col-span-2 bg-base-100 rounded-lg">
                        </div>
                        <div className="h-96 mockup-code md:col-span-2 rounded-lg">
